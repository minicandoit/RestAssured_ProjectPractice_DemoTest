...
//GET https://data.ct.gov/api/views/qm34-pq7e/rows.xml
    ...
    public void testMax(){
//
//        XmlPath xp=get("https://data.ct.gov/api/views/qm34-pq7e/rows.xml").xmlPath();
//        List<String> allUnknown=xp.getList("response.row.row.unknown");
//        System.out.println("allUnknown = " + allUnknown);
//        List<String>allYears=xp.getList("response.row.row.year");
//        System.out.println("allYears = " + allYears);
      ...
      int maxUnknown= Collections.max(unknownList);
        ...
        System.out.println("indexOfMaxUnknown = " + indexOfMaxUnknown);
