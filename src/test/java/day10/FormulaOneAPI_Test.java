...
public class FormulaOneAPI_Test {
    ...
    public void testDriverOne(){
     ...
     //send request to get information of driver_id alonso and save xml result
     //assert or assert in the chain
...
//get first given name
    ...
    public void testDriverOneAttribute() {
      ...
      //  System.out.println("xp.getString(\"MRData.DriverTable.Driver\") = " + xp.getString("MRData.DriverTable.Driver"));
        //@code==>attribute
